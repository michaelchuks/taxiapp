...
//                                     double.parse(etaDetails[widget.showInfoInt]
//                                             ['total']
//                                         .toString())) {
//                               if (!iscondition) {
//                                 iscondition = true;
...
//                                                 yourAmount.text,
//                                             'is_bid_ride': 1,
//                                             'trip_start_time': widget.fromDate
//                                                 .toString()
//                                                 .substring(0, 19),
//                                             if (widget.toDate != null)
//                                               'is_round_trip': true,
//                                             if (widget.toDate != null)
//                                               'return_time': widget.toDate
//                                                   .toString()
//                                                   .substring(0, 19),
//                                             'is_later': true,
//                                             'is_out_station': true
...
//                                           jsonEncode({
//                                             'pick_lat':
//                                                 addressList[0].latlng.latitude,
//                                             'pick_lng':
//                                                 addressList[0].latlng.longitude,
//                                             'drop_lat': addressList[
...
//                                             'drop_poc_name': addressList[
//                                                     addressList.length - 1]
//                                                 .name,
//                                             'drop_poc_mobile': addressList[
//                                                     addressList.length - 1]
//                                                 .number,
//                                             'drop_poc_instruction': addressList[
//                                                     addressList.length - 1]
//                                                 .instructions,
//                                             'goods_type_id':
...
//                                                     rentalOption[choosenVehicle]
//                                                         ['fare_amount'],
//                                                 'rental_pack_id': etaDetails[
//                                                     rentalChoosenOption]['id'],
//                                                 'offerred_ride_fare':
//                                                     yourAmount.text,
//                                                 'is_bid_ride': 1
//                                               }),
...
//                                       'vehicle_type':
//                                           userRequestData['vehicle_type_id'],
...
//                                       'trip_stops': (dropStopList.isNotEmpty)
//                                           ? jsonEncode(dropStopList)
//                                           : 'null',
...
//                                       'user_id': userDetails['id'].toString(),
//                                       'price':
//                                           userRequestData['offerred_ride_fare'],
//                                       'g': g,
//                                       'user_name': userDetails['name'],
//                                       'updated_at': ServerValue.timestamp,
//                                       'user_img':
...
//                                   iscondition = false;
//                                 });
//                               } else if (widget.isOneWayTrip == false) {
//                                 setState(() {
//                                   isLoading = true;
//                                 });
//                                 var g = widget.geo.encode(
