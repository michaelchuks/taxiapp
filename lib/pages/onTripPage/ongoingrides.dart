                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      decoration: BoxDecoration(
                                                                          ...
                                                                          image: DecorationImage(
                                                                              image: NetworkImage(myHistory[i]['driverDetail']['data']['profile_picture']),
                                                                              fit: BoxFit.cover)),
                                                                    ),
                                                                    SizedBox(
                                                                      width: media
                                                                        ...
                                                                        SizedBox(
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            children: [
                                                                              ...
                                                                              MyText(
                                                                                text: myHistory[i]['car_make_name'].toString(),
                                                                                size: media.width * twelve,
                                                                                fontweight: FontWeight.w600,
                                                                                maxLines: 1,
                                                                              ),
                                                                  ...
                                                                  (myHistory[i][
                                                                      ...
                                                                      ? Row(
                                                                          children: [
                                                                            SizedBox(
                                                                              width: media.width * 0.06,
                                                                              child: (myHistory[i]['payment_type'].toString().split(',').toList()[i] == 'cash')
                                                                                  ? Image.asset(
                                                                                      'assets/images/cash.png',
                                                                                      fit: BoxFit.contain,
                                                                                    )
                                                                                  : (myHistory[i]['payment_type'].toString().split(',').toList()[i] == 'wallet')
                                                                                      ? Image.asset(
                                                                                          'assets/images/wallet.png',
                                                                                          fit: BoxFit.contain,
                                                                                        )
                                                                                      : (myHistory[i]['payment_type'].toString().split(',').toList()[i] == 'card')
                                                                                          ? Image.asset(
                                                                                              'assets/images/card.png',
                                                                                              fit: BoxFit.contain,
                                                                                            )
                                                                                          : (myHistory[i]['payment_type'].toString().split(',').toList()[i] == 'upi')
                                                                                              ? Image.asset(
                                                                            ...
                                                                            MyText(
                                                                              text: '${userDetails['currency_symbol']} ${myHistory[i]['request_eta_amount'].toString()}',
